...
После запуска вы должно увидеть ![Данное окно](/git.jpg)
...
Открываем программу Vs Code. Перед вами должно быть ![Следующее окно](/VS.jpg)
...
Теперь нужно создать первый файл в вашей папке. Это можно сделать через саму VS Code. Для этого нужно перейти в Проводник ![Проводник](/Provod.jpg) 
